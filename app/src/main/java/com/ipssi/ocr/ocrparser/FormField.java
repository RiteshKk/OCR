...
public class FormField {
    ...
    public void addValue(String value) {
        if (value.length() < fieldconfig.getReadUptoLength())
            return;
        else if (fieldconfig.getReadUptoLength() > 0)
...
//				System.out.println("Total BestDiffThreshold Reached ["+fieldconfig.getFormFieldName()+"]["+this.sortedValues.get(0)+"],["+this.sortedValues.get(1)+"]");
    ...
    public boolean isUrlReadComplete() {
        return urlReadComplete;
    }

    public void setUrlReadComplete(boolean urlReadComplete) {
        this.urlReadComplete = urlReadComplete;
    }
}
