...
public class FormFieldConfig {
	...
	public FormFieldConfig(RectF fieldRect, String formFieldName, int type, String toMatch, String upperKey, String belowKey, String replaceExpr, int readPattern, int readDirection, int readUptoLength, int valuesReadCount, int bestDiffThreshold, int readThreshold, boolean readNextLine, boolean ignoreComplete, boolean leftLookUnbounded, boolean rightLookUnbounded, int maxLinesToLook, boolean valueIgnoreCase, String matchExpr) {
