 ...
 * </ol>
 */
public class FormGraphicOverlay<T extends FormGraphicOverlay.Graphic> extends View {
     ...
     * graphics element.  Add instances to the overlay using {@link FormGraphicOverlay#add(Graphic)}.
     */
    public static abstract class Graphic {
        private FormGraphicOverlay mOverlay;

        public Graphic(FormGraphicOverlay overlay) {
            mOverlay = overlay;
        }
    ...
    public FormGraphicOverlay(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
